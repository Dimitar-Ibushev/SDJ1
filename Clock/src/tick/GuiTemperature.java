...
import tick.Clock;
import tick.Temperature;

public class GuiTemperature extends JFrame implements Runnable
{
   ...
   {
      labelClock = new JLabel(clock.getCurrentTime());
   ...
   private class ButtonHandler implements ActionListener
   {
      ...
      public void actionPerformed(ActionEvent event)
      {
         ...
         {
            //showClock(clock.getCurrentTime());
            labelClock.setText(clock.getCurrentTime());
         }
         try
         {
